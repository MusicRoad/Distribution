...
class TuningNote
{
     ...
     * Parent Tuning.
     *
     * @ORM\ManyToOne(targetEntity="MusicRoad\InstrumentBundle\Entity\Tuning\Tuning", inversedBy="notes")
     ...
     * Note.
     *
     * @ORM\ManyToOne(targetEntity="MusicRoad\TheoryBundle\Entity\Note\Note")
