...
namespace MusicRoad\TheoryBundle\Migrations\pdo_mysql;
...
class Version20161127113725 extends AbstractMigration
{
    ...
    {
        $this->addSql("
            CREATE TABLE music_chord (
                id INT AUTO_INCREMENT NOT NULL, 
                uuid VARCHAR(36) NOT NULL,
                name VARCHAR(255) NOT NULL, 
                notesCount INT NOT NULL, 
                symbol VARCHAR(255) NOT NULL, 
                UNIQUE INDEX UNIQ_95F66C8CD17F50A6 (uuid),
                PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB
        ");
        $this->addSql("
            CREATE TABLE music_chord_interval (
        ...
        ");
        $this->addSql("
            CREATE TABLE music_degree (
                id INT AUTO_INCREMENT NOT NULL, 
                uuid VARCHAR(36) NOT NULL,
                name VARCHAR(255) NOT NULL, 
                symbol VARCHAR(255) NOT NULL, 
                UNIQUE INDEX UNIQ_327BAE9AD17F50A6 (uuid),
                PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB
        ");
        $this->addSql("
            CREATE TABLE music_interval (
                id INT AUTO_INCREMENT NOT NULL, 
                uuid VARCHAR(36) NOT NULL,
                name VARCHAR(255) NOT NULL, 
                symbol VARCHAR(255) NOT NULL, 
                ...
                value INT NOT NULL, 
                UNIQUE INDEX UNIQ_DED5B3EDD17F50A6 (uuid),
                PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB
        ");
        $this->addSql("
    ...
    public function down(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            DROP TABLE music_chord
        ");
        $this->addSql("
            DROP TABLE music_chord_interval
        ");
        $this->addSql("
            DROP TABLE music_chord_grid
        ");
        $this->addSql("
            DROP TABLE music_degree
        ");
        $this->addSql("
            DROP TABLE music_interval
        ");
        $this->addSql("
            DROP TABLE music_note
        ");
        $this->addSql("
            DROP TABLE music_note_info
        ");
        $this->addSql("
            DROP TABLE music_scale
        ");
    }
}
