...
class Note
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MusicRoad\TheoryBundle\Entity\Note\NoteInfo", cascade={"remove", "persist"})
     ...
     * Previous note.
     *
     * @ORM\OneToOne(targetEntity="MusicRoad\TheoryBundle\Entity\Note\Note")
